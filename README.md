...
### In this project,I have used both types of exception handling i.e., exception handling on local level with the use of **try-catch** block and on global level using
*@ControllerAdvice* annotation.See some of the test results-
